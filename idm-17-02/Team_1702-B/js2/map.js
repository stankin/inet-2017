function initMap() {
  ...
  AfricaKml.addListener('click', function(kmlEvent){
	  map.openInfoWindow(map.getCenter(),document.createTextNode(АФРИКА\n\nТерритория:\n 30 221 532 км²\n\nВключает:\n55 государств\n\nПлотность:\n30,51 чел./км²));
 //  showInContentWindow("АФРИКА\n\nТерритория:\n 30 221 532 км²\n\nВключает:\n55 государств\n\nПлотность:\n30,51 чел./км²");
  });
  AsiaKml.addListener('click', function(kmlEvent) {
	  map.openInfoWindow(map.getCenter(),document.createTextNode(АЗИЯ\n\nТерритория:\n44 579 000 км²\n\nВключает:\n49 государств\n\nПлотность:\n87 чел./км²));
 //  showInContentWindow("АЗИЯ\n\nТерритория:\n44 579 000 км²\n\nВключает:\n49 государств\n\nПлотность:\n87 чел./км²");
  });
  AustraliaKml.addListener('click', function(kmlEvent) {
	  map.openInfoWindow(map.getCenter(),document.createTextNode(АВСТРАЛИЯ\n\nТерритория:\n7 692 024 км²\n\nПлотность:\n2,8 чел./км²));
 //  showInContentWindow("АВСТРАЛИЯ\n\nТерритория:\n7 692 024 км²\n\nПлотность:\n2,8 чел./км²");
  });
  EuropeKml.addListener('click', function(kmlEvent) {
	  map.openInfoWindow(map.getCenter(),document.createTextNode(ЕВРОПА\n\nТерритория:\n10,18 млн км²\n\nВключает:\n50 государств\n\nПлотность:\n72,5 чел./км²));
 //  showInContentWindow("ЕВРОПА\n\nТерритория:\n10,18 млн км²\n\nВключает:\n50 государств\n\nПлотность:\n72,5 чел./км²");
  });
  NorthAmericaKml.addListener('click', function(kmlEvent) {
	  map.openInfoWindow(map.getCenter(),document.createTextNode(СЕВЕРНАЯ АМЕРИКА\n\nТерритория:\n24,25 млн км²\n\nВключает:\n23 государств\n\nПлотность:\n22,9 чел./км²));
 //  showInContentWindow("СЕВЕРНАЯ АМЕРИКА\n\nТерритория:\n24,25 млн км²\n\nВключает:\n23 государств\n\nПлотность:\n22,9 чел./км²");
  });
  SouthAmericaKml.addListener('click', function(kmlEvent) {
	  map.openInfoWindow(map.getCenter(),document.createTextNode(ЮЖНАЯ АМЕРИКА\n\nТерритория:\n17,84 млн км²\n\nВключает:\n12 государств\n\nПлотность:\n21,4 чел./км²));
