    ...
    */
    ...
    return function(inputConfig) {
        ...
        function createWelcomeElement() {
            ...
            welcomeTxt.innerHTML = "Гадюка<p></p>Используй <strong>стрелочки</strong> на клавиатуре. " + fullScreenText + "<p></p>";
            var welcomeStart = document.createElement("button");
            welcomeStart.appendChild( document.createTextNode("Ну чо сыграем?"));
        ...
        function createTryAgainElement() {
            ...
            tryAgainTxt.innerHTML = "Гадюка<p></p> Ты мертв<p></p>";
            var tryAgainStart = document.createElement("button");
            tryAgainStart.appendChild( document.createTextNode("Еще разок?"));
